...
const MemberCard = ({ name, designation, info, imgSrc, fb, li }) => (
  <div className="p-6 text-center">
    ...
    <div className="shadow-md p-4 mx-auto w-fit px-10">
      ...
      <span className="text-[#ffbb00ef]">{designation}</span>
      <p>{info}</p>
      <div className="text-2xl mt-2">
        <a href={fb} className="text-black hover:text-[#ffbb00ef] px-2"><i className="fa-brands fa-facebook"></i></a>
        <a href={li} className="text-black hover:text-[#ffbb00ef] px-2"><i className="fa-brands fa-linkedin"></i></a>
      </div>
    </div>
  </div>
);
  ...
  return (
    <div className="px-4 py-8 space-y-10">
      ...
      <section className="text-center">
        <h1 className="text-3xl font-bold text-[#ffbb00ef]">Current Advisory Panel</h1>
      ...
      {/* Committee Members */}
      <section className="text-center">
        <h1 className="text-3xl font-bold text-[#ffbb00ef]">Current Executive Committee Members (2023-2024)</h1>
      ...
      <section className="text-center">
        <h1 className="text-3xl font-bold text-[#ffbb00ef]">2022-2023 Advisory Panel</h1>
      ...
      <section className="text-center">
        <h1 className="text-3xl font-bold text-[#ffbb00ef]">2022-2023 Committee Members</h1>
