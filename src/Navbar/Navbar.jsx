            ...
            <div className="md:flex p-2  hidden  justify-between w-full mx-auto ">
                <ul className="flex flex-wrap  w-[95%] mx-auto justify-between items-center  text-white font-semibold  relative">
                    ...
                    <li className="relative group">
                        <button className="text-2xl">Activities</button>
                        ...
                        <div className="absolute top-full left-0 mt-2 w-64  bg-black text-white rounded shadow-lg z-20 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300">
                            <ul>
                                <li>
                                    <Link to="/event" className="block px-4 py-2 hover:bg-yellow-500">
                                        Events
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/news" className="block px-4 py-2 hover:bg-yellow-500">
                                        News
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/achievement" className="block px-4 py-2 hover:bg-yellow-500">
                                        Achievements
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <li className="relative group">
                        <button className="text-2xl">Members</button>
                        {/* Dropdown on hover */}
                        <div className="absolute top-full left-0 mt-2 w-64 bg-black text-white rounded shadow-lg z-20 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300">
                            <ul>
                                <li>
                                    <Link to={"/panel"} className="block px-4 py-2 hover:bg-yellow-500">Panels</Link>
                                </li>
                                <li>
                                    <Link to={"/volunteers"} className="block px-4 py-2 hover:bg-yellow-500">Volunteers</Link>
                                </li>

                                {/* Team submenu */}
                                <li className="relative group/team">
                                    <div className="flex justify-between items-center px-4 py-2 cursor-pointer hover:bg-yellow-500">
                                        <span>Team</span>
                                    ...
                                    <div className="absolute top-0 left-full ml-2 w-64 max-h-64 overflow-y-auto bg-black rounded shadow-lg z-30 opacity-0 group-hover/team:opacity-100 invisible group-hover/team:visible transition-all duration-300">
                                        <ul>
                                            {[
                                                ...
                                                <li key={role.name}>
                                                    <Link to={role.path} className="block px-4 py-2 hover:bg-yellow-500">
                                                        {role.name}
                                                    </Link>
                                                </li>
                    ...
                    <li className="relative group">
                        <button className="text-2xl">Publications</button>

                        {/* Dropdown on hover */}
                        <div className="absolute top-full left-0 mt-2 w-64 bg-black text-white rounded shadow-lg z-20 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300">
                            <ul>
                                <li>
                                    <Link to="/blog" className="block px-4 py-2 hover:bg-yellow-500">
                                        Blogs
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/researchPapers" className="block px-4 py-2 hover:bg-yellow-500">
                                        Research Papers
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/megazine" className="block px-4 py-2 hover:bg-yellow-500">
                                        Magazines
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/gallery" className="block px-4 py-2 hover:bg-yellow-500">
                                        Gallery
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/toolkit" className="block px-4 py-2 hover:bg-yellow-500">
                                        Toolkit
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <li className="relative group">
                        ...
                        <div className="absolute top-full left-0 mt-2 w-64 bg-black text-white rounded shadow-lg z-20 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300">
                            <ul>
                                <li>
                                    <Link to="/joinIEEE" className="block px-4 py-2 hover:bg-yellow-500">
                                        Join IEEE LU SB
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/blogWriting" className="block px-4 py-2 hover:bg-yellow-500">
                                        Write A Blog
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/addResearch" className="block px-4 py-2 hover:bg-yellow-500">
                                        Add Research Paper
                                    </Link>
                                </li>
                            </ul>
