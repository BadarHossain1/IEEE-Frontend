              ...
              <div className="space-y-6">
                <div className="border-b pb-6">
                  <div className="flex justify-between items-center">
                    ...
                    <button className="bg-[#ffbb00ef] text-white px-4 py-2 rounded-md">Download</button>
                  </div>
            ...
            <div className="lg:w-1/3 mt-12 lg:mt-0">
              ...
              <div className="bg-white shadow-md rounded-lg p-6">
                ...
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <h4 className="font-semibold">Sakib Absar</h4>
                    <p>15 Papers</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <img src={userImage} alt="Author" className="w-12 h-12 rounded-full" />
                  <div>
                    <h4 className="font-semibold">Muhammad Nadim</h4>
                    <p>10 Papers</p>
                  </div>
                </div>
              </div>
