        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {Array(4).fill().map((_, i) => (
            <div key={i} className="bg-gray-100 rounded-lg p-4 text-center shadow hover:shadow-lg transition">
              ...
              <span className="text-sm font-medium text-blue-500 block mt-1">Position</span>
              <div className="flex justify-center mt-3 space-x-3">
                <a href="https://www.facebook.com/ieeecslu" className="text-blue-600 hover:text-blue-800 text-xl"><i className="fab fa-facebook"></i></a>
                <a href="https://www.linkedin.com/company/ieeecslu/" className="text-blue-600 hover:text-blue-800 text-xl"><i className="fab fa-linkedin"></i></a>
              </div>
            </div>
          ))}
        </div>
