  ...
  return (
    <section className="relative h-[772px] w-full">
      ...
      <div className="absolute top-[100px] left-1/2 transform -translate-x-1/2 w-[90%] md:w-[40%] bg-black/60 text-white p-10 text-center z-10 rounded-md shadow-md">
        ...
        <p className="text-sm">
          I have an account!{' '}
          <Link href="signin.html" className="text-[#f7a320] hover:underline">
            Sign In
          </Link>
        </p>
        ...
        <form className="flex flex-col gap-5 w-[70%] mx-auto mt-5">
          ...
          <input
            ...
            className="p-2 rounded-md bg-black border border-[#f7a320] text-white placeholder:text-white"
          />
          <input
            type="email"
            name="email"
          ...
          <button
            type="submit"
            className="p-2 rounded-md bg-[#f7a320] text-white border border-[#f7a320] hover:bg-transparent hover:text-white transition-all"
          >
            Submit
          </button>
        </form>
