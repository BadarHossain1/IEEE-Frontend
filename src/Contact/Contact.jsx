...
const Contact = () => {
    return (
        <section className="bg-white px-6 py-10 text-center">
            <h2 className="text-3xl font-bold text-yellow-400 mb-2">Contact Us</h2>
            ...
            <div className="flex flex-col lg:flex-row gap-10 mt-10 max-w-screen-xl mx-auto">
                ...
                <div className="flex-1 bg-white p-6 rounded-xl shadow-md">
                    <form className="text-left space-y-4">
                        ...
                        <button type="submit" className="w-full bg-orange-400 hover:bg-orange-500 text-white font-medium py-2 px-4 rounded transition">Send Message</button>
                    </form>
                </div>
